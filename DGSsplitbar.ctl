...
Begin VB.UserControl splitbar 
   ...
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   647
   ToolboxBitmap   =   "DGSsplitbar.ctx":0000
End
...
'    m_MinTopHeight = PropBag.ReadProperty("MinTopHeight", m_def_MinTopHeight)
    ...
    UserControl.MousePointer = PropBag.ReadProperty("MousePointer", 7)
End Sub
...
'    Call PropBag.WriteProperty("MinTopHeight", m_MinTopHeight, m_def_MinTopHeight)
    ...
    Call PropBag.WriteProperty("MousePointer", UserControl.MousePointer, 7)
End Sub
